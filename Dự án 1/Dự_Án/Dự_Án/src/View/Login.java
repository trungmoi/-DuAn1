...
public class Login extends javax.swing.JFrame {
    ...
    private DAO.DAO_Login rp = new DAO_Login();
    View.Main_Admin a = new Main_Admin();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/online-shopping.png"))); // NOI18N
        jLabel2.setText("     N5 SHOP");
        ...
        txt_tk.setBackground(new java.awt.Color(204, 204, 204));
        txt_tk.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        txt_tk.setForeground(new java.awt.Color(51, 51, 51));
        txt_tk.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jLabel6)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txt_tk, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel7)
    ...
    private void btLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLoginActionPerformed
        if (checkNull()) {
            ...
            int x = rp.getIdNv(tk, mk);
            int i = rp.getRole(tk, mk);
            int y = rp.getRole(tk, mk);
            ...
            if (i == 0 || x == 0) {
                ...
                if (i == 1) {
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Đăng nhập Thành công Kho");
                    a.setVisible(true);
                    dispose();
                } else {
